...
const booksData = [
  {
    id: 1,
    title: "JLPT & NAT",
    subtitle: "Courses N5-N2",
    color: "#1a1a1a", // Black
    summary: "A complete guide to mastering Japanese proficiency tests.",
    content: "Our curriculum covers all aspects of the JLPT and NAT exams. From grammar drills to listening practice, we ensure you are fully prepared."
  },
  {
    id: 2,
    ...
    content: "Learn specific strategies to manage time, identify keywords, and handle difficult questions with calm and confidence."
  },
  {
    id: 3,
    ...
    content: "Master the basics of Hiragana and Katakana. Build a strong foundation with essential vocabulary for daily interactions."
  },
  {
    id: 4,
    title: "Kanji Mastery",
    ...
    content: "We use mnemonics and radical decomposition to help you memorize and understand thousands of Kanji characters effectively."
  },
  {
    id: 5,
    title: "Speaking Club",
    ...
    content: "Join our community to practice speaking with natives. Improve your accent, intonation, and spontaneous response skills."
  }
];
          ...
          >
            ...
            <div className="cover-group">
              ...
              <div className="left-page">
                ...
                <div className="page-content" style={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
