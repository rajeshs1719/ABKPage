...
const videoThumb1 = "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=600&auto=format&fit=crop";
const videoThumb2 = "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=600&auto=format&fit=crop";
...
export const directorsData = {
  bangalore: {
    ...
    videos: [
      {
        caption: "Aenean magna nisl, mollis quis, molestie eu, feugiat in, orci. Vestibulum erat nulla.",
        thumbnail: videoThumb1,
      },
      {
        caption: "Duis sapien sem, aliquet nec, commodo eget, consequat quis, neque. Aliquam faucibus.",
  ...
  coimbatore: {
    ...
    videos: [
      {
        caption: "Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate.",
        thumbnail: videoThumb2,
      },
      {
        caption: "Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra.",
        thumbnail: videoThumb1,
      },
    ],
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 -mt-16 md:-mt-20 relative z-20">
          ...
          >
            ...
            <div className="space-y-6 text-[#4b5563] leading-relaxed text-[16px] md:text-[17px]">
              {data.introParagraphs.map((para, idx) => (
                <p key={idx} className="font-light">{para}</p>
              ))}
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-white px-8 py-10 rounded-[15px] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 relative">
            {/* Decorative Quotes */}
            <span className="absolute text-[#E8ECE9] text-8xl font-serif -top-6 left-6 leading-none select-none">"</span>
